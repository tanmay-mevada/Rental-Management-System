          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
              <div className="bg-gray-50 rounded-lg p-4">
                <h3 className="font-semibold text-gray-700">Admin Access</h3>
                <p className="text-lg font-bold text-gray-900 mt-2">Full Control</p>
              </div>
              <div className="bg-gray-50 rounded-lg p-4">
                <h3 className="font-semibold text-gray-700">Account Type</h3>
                <p className="text-lg font-bold text-gray-900 mt-2">Administrator</p>
              </div>
              <div className="bg-gray-50 rounded-lg p-4">
